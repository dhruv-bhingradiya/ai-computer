              ...
              {result ? (
                <div className="grid grid-cols-1 gap-6">
                  <section className="bg-[#111] border border-[#00FF00] p-6 rounded-sm">
                    ...
                    {!result.top_ai_tools && result.raw && (
                  ...
                  {result.videos_processed && (
                    <section className="bg-[#111] border border-[#333] p-6 rounded-sm">
                      <div className="flex items-center gap-2 mb-6 text-[#00FF00]">
                        <Layers className="w-4 h-4" />
                        <h2 className="text-xs font-bold uppercase tracking-widest">Source Video Analysis</h2>
                      </div>
                      <div className="space-y-3">
                        {result.videos_processed.map((vid: any, i: number) => (
                          <div key={i} className="bg-black border border-[#222] p-4 flex items-center justify-between">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <div className="text-xs font-bold text-white uppercase tracking-wider">{vid.title}</div>
                                <div className="text-[9px] text-[#444] mt-1 truncate max-w-md">{vid.url}</div>
                              </div>
                            </div>
                            <div className="flex items-center gap-6">
                              <div className="text-right">
                                <div className="text-[9px] text-[#444] uppercase mb-1">Quality</div>
                                <div className="text-[10px] font-bold text-[#00FF00] uppercase">{vid.transcript_quality}</div>
                              </div>
                              <div className="text-right">
                                <div className="text-[9px] text-[#444] uppercase mb-1">Tools</div>
                                <div className="text-[10px] font-bold text-white">{vid.tools_detected?.length || 0}</div>
                              </div>
                            </div>
                          </div>
                        ))}
